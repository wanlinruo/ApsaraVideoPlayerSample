...
public class GetVodAuthActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void run() throws Exception {
        Request request = new Request.Builder().url("http://192.168.97.6:9005/content/vodInfo/getVideoIdAddr").build();
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    if (object != null) {
                        ...
                        videoId = object.optString("videoId");
                    }
    ...
    private void startActivity(int type) {
        ...
        vodintent.putExtra("VideoId", videoId);
